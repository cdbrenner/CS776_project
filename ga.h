...
class GA
{
    ...
    public:
        GA(int argc, char *argv[], int iterator, std::string problem_type, int ga_variant, std::string ga_variant_name_abbreviation, double mutation_probability, double xover_probability, int chromosome_length, std::ofstream& log_file_stream);
        ~GA();
