...
void eval(Individual& individual, Eval_results& results, int tour_data[][48], int choice, int random_seed, int srand_offset)
{
    try
        // {TSP(individual, tour_data, tour _count, choice, results);}
        {TSP(individual, tour_data, choice, results);}
