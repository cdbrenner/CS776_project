...
class Population
{
    ...
    public:
        ...
        void evaluate(int choice, int data[][48], int random_seed, int srand_offset);
        void evaluate_single(Individual&, int choice, int data[][48], int random_seed, int srand_offset);
