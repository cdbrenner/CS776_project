...
int main(int argc, char* argv[])
{
    ...
    try
    {
        try_args_to_int_in_range(argv[2], chromosome_length, 24, 48, 48, "argv[2]");
    ...
    catch(std::string error_message)
    {
        if(error_message == "argv[2]")
        {
            ...
            std::cout << "argv[2] = 24 or 48" << std::endl;
    ...
    for(int j = 0; j < runs; j++)
    {
        ...
        try
        {
            GA ga(argc, argv, j, problem_type, ga_variant_option, variant_name_abbreviation, mutation_rate, xover_rate, chromosome_length, log_stream);
    ...
    {
        std::ofstream out;
        GA ga(argc, argv, runs, problem_type, ga_variant_option, variant_name_abbreviation, mutation_rate, xover_rate, chromosome_length, out);
